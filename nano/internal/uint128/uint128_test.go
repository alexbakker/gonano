...
func TestSub(t *testing.T) {
	testData := []struct {
		...
		{Uint128{0, 1}, Uint128{0, 0}, Uint128{0, 1}},
		{Uint128{18446744073709551615, 18446744073709551615}, Uint128{18446744073709551615, 18446744073709551614}, Uint128{0, 1}},
		{Uint128{0, 18446744073709551615}, Uint128{0, 18446744073709551614}, Uint128{0, 1}},
		{Uint128{18446744073709551615, 0}, Uint128{18446744073709551614, 18446744073709551615}, Uint128{0, 1}},
		{Uint128{18446744073709551615, 0}, Uint128{18446744073709551614, 18446744073709551591}, Uint128{0, 25}},
	}
...
func TestAdd(t *testing.T) {
	testData := []struct {
		...
		{Uint128{0, 0}, Uint128{0, 1}, Uint128{0, 1}},
		{Uint128{18446744073709551615, 18446744073709551614}, Uint128{18446744073709551615, 18446744073709551615}, Uint128{0, 1}},
		{Uint128{0, 18446744073709551615}, Uint128{1, 0}, Uint128{0, 1}},
		{Uint128{18446744073709551615, 0}, Uint128{18446744073709551615, 1}, Uint128{0, 1}},
		{Uint128{0, 18446744073709551615}, Uint128{1, 24}, Uint128{0, 25}},
	}
